...
export const Mutation = {
  addCv: (_, { input }, { data, pubSub }) => {
    ...
    pubSub.publish("cvEvent", "new cv added");
    return newCv.id;
  },
  deleteCv: (_, { id }, { data, pubSub }) => {
    ...
    pubSub.publish("cvEvent", "cv deleted");
    return id;
  },
  updateCv: (_, { input }, { data, pubSub }) => {
    ...
    pubSub.publish("cvEvent", "cv updated");
    return cv.id;
  },
};
